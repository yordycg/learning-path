...
| ------ | ------------------------------------------------------------------------------------------------------------------------ | ---------------------------- | ------------------------------- | ------------------------------------- | ------ |
| Lun 21 | **Big O**: qué mide, peor caso y crecimiento (conteo de ops vs N). Ω/Θ y amortizado quedan FUERA de hoy (nivel 2+)        | `c/1-big-o.c`                | ★ freeCodeCamp · Fiset/Silver.dev/AlgoMaster (apoyo) | `DSA - Big O...` (revisar duplicados) | [ ]    |
