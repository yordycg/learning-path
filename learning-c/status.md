...
| ------ | -------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ------ |
| Lun 7  | **¿Qué es una señal?** entrega async, disposiciones default (terminar/ignorar/núcleo), señales comunes; generar con `raise()` y Ctrl+C | `3-expert/07-signals/1-signals-intro.c` | [intro señales](https://www.youtube.com/watch?v=5We_HtLlAbs) · Beej 29 · `man 7 signal` · TLPI cap. 20 | `Linux - Signals Intro.md`                                                     | [ ]    |
...
- **S4 Lun (Lun 7): D1 — ¿Qué es una señal?** (intro). Crear `3-expert/07-signals/1-signals-intro.c` con el Contrato diario. Respuesta del día: árbol de contexto + contexto 2 min + archivo `.c` + recurso JIT (se abre SOLO si falla) + exercises + plantilla comentarios.
