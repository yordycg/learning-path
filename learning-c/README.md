...
| `4-systems/01-syscalls-processes/`  | K&R 8 · `man 2`                     | [fork()](https://www.youtube.com/watch?v=ss1-REMJ9GA) (Sorber) · ¿qué es un syscall? — [kernel-internals.org/syscalls](https://kernel-internals.org/syscalls/) + [Understanding system calls](https://surajincloud.substack.com/p/understanding-system-calls-in-linux) (Narwade)                                                                                      |                  |
| `4-systems/02-pipes-ipc/`           | —                                   | [pipe()](https://www.youtube.com/watch?v=8AXEHrQTf3I) (Sorber)                                                                                                                                                                                                            |                  |
| `4-systems/03-file-descriptors/`    | —                                   | [Inside Linux File Descriptors](https://www.youtube.com/watch?v=saMebwRO-Q8) (Tech Fairy) · [clips FD](https://my.eng.utah.edu/~cs4400/file-descriptor.html) (Utah CS4400) · [dup2](https://www.youtube.com/watch?v=PIb2aShU_H4) (Kris Jordan) · [dup2 redirect stdout](https://www.baeldung.com/linux/c-dup2-redirect-stdout) (Baeldung)     |                  |
