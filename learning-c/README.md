...
- [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) (OSTEP, Arpaci-Dusseau) – **gratis online**. Para el concepto de procesos/scheduling antes de codear: caps. 4–6 (abstracción proceso), 13 (espacio de direcciones). Encaja con el método concept-first.
