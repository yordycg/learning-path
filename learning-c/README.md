...
| `3-expert/07-signals/`              | §29                                 | [kill/signal/sigaction](https://www.youtube.com/watch?v=83M5-NPDeWs) + [intro corta](https://www.youtube.com/watch?v=5We_HtLlAbs)                                                                                                                                         | **TLPI caps. 20–22** (señales)  |
| `3-expert/08-modern-c/`             | §32, §41                            | —                                                                                                                                                                                                                                                                         | solo Beej        |
| `4-systems/01-syscalls-processes/`  | K&R 8 · `man 2`                     | [fork()](https://www.youtube.com/watch?v=ss1-REMJ9GA) (Sorber) · ¿qué es un syscall? — [kernel-internals.org/syscalls](https://kernel-internals.org/syscalls/) + [Understanding system calls](https://surajincloud.substack.com/p/understanding-system-calls-in-linux) (Narwade)                                                                                      | **TLPI caps. 24–29** (procesos), **34** (process groups) · OSTEP caps. 4–6 |
| `4-systems/02-pipes-ipc/`           | —                                   | [pipe()](https://www.youtube.com/watch?v=8AXEHrQTf3I) (Sorber)                                                                                                                                                                                                            | **TLPI cap. 44** (pipes/FIFOs)  |
| `4-systems/03-file-descriptors/`    | —                                   | [Inside Linux File Descriptors](https://www.youtube.com/watch?v=saMebwRO-Q8) (Tech Fairy) · [clips FD](https://my.eng.utah.edu/~cs4400/file-descriptor.html) (Utah CS4400) · [dup2](https://www.youtube.com/watch?v=PIb2aShU_H4) (Kris Jordan) · [dup2 redirect stdout](https://www.baeldung.com/linux/c-dup2-redirect-stdout) (Baeldung)     | **TLPI cap. 5** (FDs)           |
| `—` (proyecto mysh)                 | —                                   | [Write a Shell in C](https://brennan.io/2015/01/16/write-a-shell-in-c/) (Brennan) · [HW2 Shell](https://ics.uci.edu/~aburtsev/143A/hw/hw2-shell/hw2-shell.html) (UCI — sin copiar código)                                                                                  | solo read/parse  |

> **Video canónico de fork/exec (4-systems):** usar siempre [fork()](https://www.youtube.com/watch?v=ss1-REMJ9GA) (Sorber, `ss1-REMJ9GA`) para fork y [-_7BcxBr4P4](https://www.youtube.com/watch?v=-_7BcxBr4P4) (Sorber) para exec. Estos son los que están en el roadmap y en el plan semanal. No usar `Pzd9G9R7Kmo`.
...
- [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) (OSTEP, Arpaci-Dusseau) – **gratis online**. Para profundizar en procesos/scheduling/memoria: caps. 4–6 (abstracción proceso), 13 (espacio de direcciones). Lectura JIT cuando el código falla o el man page no alcanza.
- [Operating Systems (AlgoMaster.io)](https://algomaster.io/learn/operating-systems) – **curso interactivo en C**, alineado con el track `4-systems`: procesos (fork/exec/wait, PCB, zombies, signals), scheduling, threads, sync, IPC, I/O, malloc/paging/COW/mmap, file systems, containers. Abrir por **sección/tema** (método JIT): S3 procesos → sección "Processes", S5 pipes → "Inter-Process Communication". Complementa a TLPI con explicaciones visuales.
